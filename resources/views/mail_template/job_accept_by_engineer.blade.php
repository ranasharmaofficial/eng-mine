                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:green; font-family:'Ubuntu', Arial,sans-serif; font-weight:700;font-size:30px; line-height:30px; text-align:center; padding-bottom:10px;">Order Accepted Alert!</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:17px; line-height:15px; color:#000; padding-bottom:30px;">
															...
															<p>Hi Admin!!! </p>
															<p>Engineer ({{ $engineer_details->first_name.' '.$engineer_details->last_name }}) has been successfully accepted the request for Order no. {{ $order_details->service_order_id }}.</p>
