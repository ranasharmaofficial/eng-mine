                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:30px; line-height:60px; text-align:center; padding-bottom:10px;">Order Placed Successfully!</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:17px; line-height:15px; color:#000; padding-bottom:30px;">
															...
															<p>Thanks for choosing Engineersmine.com.</p>
															<p>We have received your order and it is under review. We will provide further updates regarding Engineer’s detail and schedule soon.</p>
															<p>Please find the Order summary below.</p>
															<p>Order No.: {{ $order_details->service_order_id }}</p>
															<p>Requested Schedule.: {{ $order_details->app_date }}  {{ $order_details->app_time }}</p>
