                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:30px; line-height:60px; text-align:center; padding-bottom:10px;">New Engineer Registration</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:17px; line-height:15px; color:#000; padding-bottom:30px;">
															...
															<p>Hi Admin,</p>
															<p>Congratulation!!! New Engineer registration No. {{ $user_details->username }} has done, Please approve his profile by clicking on below link.</p>
															<p><strong>In order to complete your registration, please click on the link provided below:</strong></p>
															<p><a  href="{{ url('admin/engineer-list') }}">Click to Approve</a></p>
