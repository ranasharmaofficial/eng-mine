                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:green; font-family:'Ubuntu', Arial,sans-serif; font-weight:700;font-size:30px; line-height:30px; text-align:center; padding-bottom:10px;">Order Completed!</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:17px; line-height:15px; color:#000; padding-bottom:30px;">
															...
															<p>Congratulation!!!!</p>
															<p>Dear Customer, Your Service Order no. ({{ $order_details->service_order_id }}) has been completed successfully. </p>
															<p>Please provide Feedback by clicking below link</p>
															<a href="{{ url('customer/add-feedback') }}">Click Here</a>
