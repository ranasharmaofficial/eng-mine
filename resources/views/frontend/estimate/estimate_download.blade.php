...
<html lang="en">
   <head>
      ...
      <title>Estimate Quotation #{{ $temp_order_id }}</title>
      <style>
         html,
         body {
         margin: 10px;
   ...
   <body>
         ...
         <thead>
            <tr>
               ...
               <td style="border:none">
                  <p style="font-size:25px; padding-top:72px;position:relative;top:30px;">Estimate</p>
         ...
         <tr>
            <td width="50%"style="border:none; padding:0;margin:0;">
               <table width="100%" style="border:none;">
                  ...
                  <tr style="width:50%; display:inline-block;">
                     <td style="width:100%; border:none; display:inline-block; padding:0px 0px 0px 8px; margin:0;">
                        <b> :{{ $tempOrderDetails->unique_id }}</b>
                     </td>
                     <td style="width:100%; border:none; display:inline-block; padding:0px 0px 0px 8px; margin:0;">
                        <b>:  Due on Receipt</b>
                     </td>
	...
	@if(count($tempOrderDetails)>0)
      ...
      <tr>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4"></td>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4""></td>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4""></td>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4""></td>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4""></td>
            <td style=" border:none; border-right:1px solid #9e9e9e; border-bottom:1px solid #9e9e9e; background-color:#f2f3f4"" colspan="2" align="center"><b>IGST</b></td>
            <td style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4""></td>
         </tr>
         <tr>
            ...
            <th style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4; text-align:right;">%</th>
            <th style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4; text-align:right;">Amt</th>
            <th style="border:none; border-right:1px solid #9e9e9e; background-color:#f2f3f4; text-align:right;">Amount</th>
         </tr>
        @foreach($tempOrderDetails as $key => $item) 
		 <tr>
            ...
            <thead>
               <tr>
                  <td class="text-start heading;" style="width: 50%;">
                     <p>Total In Words</p>
                     <p style="font-weight:bold;"><i>Indian Rupee Two Crore Fifty-Eight Lakh Seventy-Seven Thousand</i></p>
                     <p style="font-weight:bold;"><i>Four Hundred Only</i></p>
                     <p style="padding:30px 0">Looking forward for your business</p>
                      <ul>
                        <li style="list-style:none;">Terms & Conditions</li>
                        <li style="list-style:none;">Delivery 3-4 Days after PO</li>
                        <li style="list-style:none;">Payment 100% advance
</li>
                      </ul>
                  ...
                  <td class=" text-start heading;" style="width: 50%; margin:0; padding:0;">
                     <table id="table2" style="border:none;">
                        ...
                        <tr>
                           <th style="color: #000; border:none;  border-bottom:1px solid #dddddd; font-size:12px; font-weight:bold; text-align:right; padding:0px 20px 0px 20px; margin:0;">Total</th>
                           <td style="border:none; border-bottom:1px solid #dddddd; padding:0; margin:0;"><b>Rs<b/>&nbsp;{{ number_format($grand_total, 2) }}</td>
                        </tr>
                        <tr>
                           <td style="border:none;">
                              <h1>img</h1>
	...
	@endif
		...
		@if(count($tempOrderDetails)>0)
         <table width="100%">
			@foreach($tempOrderDetails as $key => $val)
            <tr>
                <td>
