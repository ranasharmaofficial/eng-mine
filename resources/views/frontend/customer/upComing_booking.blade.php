...
@section('title') Upcoming Booking @endsection
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="row">
                        <div class="widget-title d-flex align-items-center justify-content-between">
                            <h4 class="d-none d-lg-inline-block fw-bold">Upcoming Booking List</h4>
                            <div class="d-flex align-items-center w-50 justify-content-between ms-auto">
                                ...
                                <a href="{{ route('customer.add_booking') }}" class="fs-14 py-1 bg-primary2 rounded-pill px-4 text-white text-center bt-hover">
                                    Book Service
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4 border border-1 py-3 rounded">
                        ...
                        <div class="col-lg-3 position-relative">
                            ...
                            <img src="{{ static_asset('assets/assets_web/img/gallery/heart-icon.svg')}}" alt="" class="img-fluid rounded position-absolute top-0 end-0 pe-3 pt-2 rounded-circle">
                        </div>
                        <div class="col-lg-9 mt-3 mt-lg-0">
                            ...
                            <div class="d-flex">
                                ...
                                @elseif($val->status==6)
                                <span class="badge bg-danger text-white fw-bold ms-2 px-3">Upcoming</span>
                                @elseif($val->status==5)
                            ...
                            <ul class="booking-details">
                                <li>
                                    ...
                                    <a href="javascript:void();" class="bg-secondary bg-opacity-25 px-2 py-1 rounded text-primary2" data-bs-toggle="modal" data-bs-target="#add-wallet{{$key+1}}">
                                        View Service
                                    </a>
                                </li>
                                <li>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header border-bottom-0 justify-content-between pb-0">
                                    <h5 class="modal-title ">Upcoming Service</h5>
                                    <button type="button" class="close-btn px-2 py-1 border-0 rounded-circle" data-bs-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i>
                                    </button>
                                </div>
                                <hr>
