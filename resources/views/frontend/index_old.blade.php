        ...
        <div class="content text-center" style="z-index: 100;">
            ...
            <div class="row d-none d-lg-block d-xl-block">
                <div class="col-sm-11 mx-auto check-sloat-form">
                    <div id="check-sloat-form-data" class="row bg-white bg-opacity-50 px-4 py-2 mx-md-5 rounded-pill ">
                        ...
                        <div class="col-sm-3 px-0">
                            <input type="date" min="{{ date('Y-m-d') }}" name="service_date" id="service_date" class="form-control bg-transparent border-0 fs-5">
							<span class="form-text text-danger" id="service_date_error"></span>
                        </div>
                        <div class="col-sm-4 px-0">
                            <div class="row">
                                <div class="col-6 px-0">
                                    <input name="service_time" id="service_time" type="time" class="form-control bg-transparent border-0 fs-5">
						...
						<span class="form-text text-success" id="web_sloats_found_available"></span>
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                  <div class="get-service-main">
                     ...
                     <div class="get-service-content">
                        <a href="#"><h5 class="mt-4 mb-3">{{ $val->title }}</h5></a>
