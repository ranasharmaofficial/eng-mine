...
@section('title') Upcoming Job @endsection
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="widget-title d-flex align-items-center justify-content-between">
                        <h4 class="fw-bold">Upcoming Job</h4>
                    </div>
                    <hr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-light-success">
                                            ...
                                            @endif
                                            <button onclick="updateEngineerJobStatus(this)" id="{{ $val->id }}" class="btn btn-primary">Take Action</button>
                                        </td>
                                        <td class="text-light-success">
                                            @if($val->job_accept=='accept')
                                            <button onclick="updateStartJobStatus(this)" style="background-color:green !important;" id="{{ $val->id }}" class="btn btn-success">Start Job</button>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
            ...
            <form method="" id="start-job-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-12  my-3">
                        <center><label style="font-weight:bold;">Are you sure you want to start this job?</label></center>
                    </div>

                    <div class="col-sm-offset-2 col-sm-10  my-3">
                        <input type="hidden" name="engId" id="engId">
                        <input type="hidden" name="id" id="jobId">
                        <input type="hidden" name="order_id" id="orderIddd">
        ...
        <div class="modal-content">
			<form method="" id="update-engineer-job-status">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-offset-2 col-sm-10  my-3">
                        <input type="hidden" name="engId" id="engIdd">
                        <input type="hidden" name="id" id="jobIdd">
...
<script type="text/javascript">
    $(document).on('click', '.start_job_button', function(e) {
        ...
        $.ajax({
            type: "POST"
            , url: "{{ route('engineer.startEngineerJob') }}"
            , data: formData
            , processData: false
            , contentType: false
            , dataType: "JSON"
    ...
    function updateStartJobStatus(updateStartJobStatus) {
        ...
        $.ajax({
            ...
            , success: function(response) {
                ...
                $('#orderIddd').val(response.order_id);
            }
        })
    }
    ...
    function updateEngineerJobStatus(updateEngineerJobStatus) {
        ...
        $.ajax({
            ...
            , success: function(response) {
                // toastr.success("Status Successfully Updated");
                $('#engIdd').val(response.engineer_id);
                $('#jobIdd').val(response.id);
