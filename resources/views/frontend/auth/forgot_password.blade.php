                        ...
                        <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel"
                           aria-labelledby="ex1-tab-1">
                            <form id="password-recover-form" action="#">
								...
								<button class="btn btn-primary rounded-pill" type="button" id="button-addon2" style="width:100px; margin-top:0.5%;" onclick="getOTP()">Send OTP</button>
                                ...
                                <div id="otp_input_box" style="display: none;" class="form-group pt-3">
									...
									<button style="margin-top:1.5%;" class="btn btn-success rounded-pill" type="button" id="check-mobile-otp-button" onclick="checkMobileOtp()">Check OTP</button>
							    </div>
...
<script type="text/javascript">
	...
	function getOTP(){
        ...
        $.ajax({
            url: '{{ url('get-otp-forgot-password' )}}',
            method: 'POST',
	...
	function checkMobileOtp(){
        ...
        $.ajax({
            url: '{{ url('check-forgot-mobile-otp' )}}',
            method: 'POST',
