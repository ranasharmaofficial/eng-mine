                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:30px; line-height:60px; text-align:center; padding-bottom:10px;">OTP Received from Engineer Mine</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:center; color:#000; padding-bottom:30px;">
                                                            
															<p>Dear {{ $user_details->first_name.' '.$user_details->last_name}},</p>
															<p>Thank you for registering your organisation on EngineersMine.com</p>
															<p><strong>In order to complete your registration, please click on the linkprovided below:</strong></p>
															<p><a href="{{ url('customer/profile') }}"><strong>Click here to complete your account</strong></a><strong> registration</strong></p>
															<p>For any Support call us at 9870407840 or mail at support@engineersmine.com</p>
															<p><strong>&nbsp;</strong></p>
															<p><strong>Warm Regards</strong></p>
															<p><strong>Team EngineersMine</strong></p>
