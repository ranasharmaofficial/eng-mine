...
@section('title', 'Customer Estimate List')
          ...
          <div class="col">
            <div class="breadcrumb ">
              <a href="{{ url('admin/dashboard') }}">
                <i class="fa fa-home" aria-hidden="true"></i> Dashboard </a> / Customer Estimate List
            </div>
          </div>
          <div class="col">
            <a href="{{ route('admin.customer_list') }}" class="btn btn-info float-right veiwbutton">
				...
				@foreach($estimate_list as $key => $item) 
					...
					<div class="wrapBoxContent">
                        <div class="button cssCollapse-target cssCollapse-noScroll">
                            ...
                            <!--<a style="float:right;margin-right:5px;" target="_blank" href="{{ static_asset('uploads/cost_estimate/'.$item->files) }}" class="btn btn-primary btn-sm">View Attcahed Doc.</a>
                            <a style="float:right;margin-left:5px;" href="{{ url('estimate/download-estimate/'.$item->id) }}" class="btn btn-danger btn-sm">Download Quotation</a>-->
                        </div>
                        ...
                        <div class="boxHidden cssCollapse-hiddenContent">
                            <div class="innerText">
								...
								<div class="row">
										...
										<!--<div class="col-md-3">
											<a style="float:right;" href="{{ url('customer/customer/view-estimate-details/'.$item->id) }}" class="btn btn-danger btn-sm">View Quotation Details</a>
										</div>-->
									</div>
